...
async def fetch_stock_price(server_name: str):  # ประกาศฟังก์ชัน fetch_stock_price สำหรับรวมขั้นตอนการทำงาน
    """
    ...
    """
    url = f"http://127.0.0.1:8088/price/{server_name}"  # กำหนดหรือปรับค่าให้ url
