...
if __name__ == "__main__":  # ตรวจสอบว่าไฟล์นี้ถูกเรียกใช้งานโดยตรงหรือถูก import
    ...
    webbrowser.open("http://127.0.0.1:8002")  # ดำเนินคำสั่งของบรรทัดนี้ตามลำดับการทำงาน
    # รัน FastAPI Server บนเครื่องนักเรียน Port 8002
    uvicorn.run(app, host="127.0.0.1", port=8002)  # ดำเนินคำสั่งของบรรทัดนี้ตามลำดับการทำงาน